...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> '.wp_get_theme().' is a free premium WordPress theme. This is a responsive theme with features like custom menu, featured images, widgetized sidebar etc. Theme also comes with an option panel.  </p>
